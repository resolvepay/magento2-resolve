...
define([
    ...
    function ($, $t) {
        ...
        return {
            options: {},
            aSLowAsElement: 'resolve-as-low-as',
            ...
            processAsLowAs: function(options) {
                var self = this;
                resolve.ui.ready(function() {
                    if (options.amount) {
                        var isUpdate = self.updateResolveAsLowAs(options.amount);
                        if (isUpdate) {
                            if(options.color_id) {
                                document.getElementById(options.element_id).setAttribute('data-resolve-color',options.color_id);
                            }
            ...
            /**
             * Update resolve as low as
             *
             * @param c This is amount in cents
             */
            updateResolveAsLowAs: function(c) {
            ...
            loadScript: function(options) {
                ...
                var pubKey = options.public_api_key,
                    ...
                    _resolve_config = {
                        public_api_key: pubKey, /* Use the PUBLIC API KEY Resolve sent you. */
                        script: script
                    };
                (function(l, g, m, e, a, f, b) {
                    ...
                    d(g);
                    l[m] = c
                })(window, _resolve_config, "resolve", "checkout", "ui", "script", "ready");
            },
            ...
            updatePromoBlocksVisibility: function(visibility) {
                ...
                var promoBanners = document.getElementsByClassName('resolve-promo');
                if (promoBanners[0]){
