...
class FinancingProgram
{
    ...
    {
        return  $this->isALS ?
            $this->resolvePaymentConfig->getAsLowAsValue('promo_id_value_default') :
            $this->resolvePaymentConfig->getMfpValue('financing_program_value_default');
    }
    ...
    {
        return $this->isALS ?
            $this->resolvePaymentConfig->getMfpValue('promo_id_value') :
            $this->resolvePaymentConfig->getMfpValue('financing_program_value');
    }
    ...
    {
        return $this->resolvePaymentConfig->getMfpValue('start_date_mfp');
    }
    ...
    {
        return $this->resolvePaymentConfig->getMfpValue('end_date_mfp');
    }
    ...
    {
        return $this->isALS ?
            $this->resolvePaymentConfig->getMfpValue('promo_id_cart_size_value') :
            $this->resolvePaymentConfig->getMfpValue('financing_program_cart_size_value');
    }
    ...
    {
        return $this->resolvePaymentConfig->getMfpValue('financing_program_cart_size_min_order_total');
    }
    ...
    {
        return $this->resolvePaymentConfig->getMfpValue('financing_program_cart_size_max_order_total');
    }
    ...
    public function getCustomerFinancingProgram()
    {
        ...
        if (null === $this->customerFP) {
            if ($this->customerSession->isLoggedIn()) {
                $this->customerFP = $this->customerSession->getCustomer()->getResolveCustomerMfp();
            } else {
                $this->customerFP =  $this->customerSession->getResolveCustomerMfp();
            }
        ...
        foreach ($productCollection as $product) {
            ...
            if($this->isALS) {
                $categoryProductCollection
                    ->addAttributeToFilter('resolve_category_promo_id', array('neq' => ''))
                    ->addAttributeToFilter('resolve_category_promo_id', array('notnull' => true));
            } else {
                $categoryProductCollection
    ...
    protected function convertProductCollectionToItemsArray(
        ...
        foreach ($collection as $entity) {
            $start_date = $entity->getResolveProductMfpStartDate();
            $end_date = $entity->getResolveProductMfpEndDate();
            $_value = $this->isALS ? $entity->getResolveProductPromoId() : $entity->getResolveProductMfp();
            ...
            $entityItems[] = [
                'value'    => $mfpValue,
                'type'     => $entity->getResolveProductMfpType(),
                'priority' => $entity->getResolveProductMfpPriority() ?: 0
            ];
        }
        return $entityItems;
    }
    ...
    protected function convertCategoryCollectionToItemsArray(
        ...
        $entityItems = [];
        foreach ($collection as $entity) {
            $start_date = $entity->getResolveCategoryMfpStartDate();
            $end_date = $entity->getResolveCategoryMfpEndDate();
            $_value = $this->isALS ? $entity->getResolveCategoryPromoId() : $entity->getResolveCategoryMfp();
            if(empty($start_date) || empty($end_date)) {
                $mfpValue = $_value;
            } else {
                if($this->_localeDate->isScopeDateInInterval(null, $start_date, $end_date)) {
            ...
            $entityItems[] = [
                'value'    => $mfpValue,
                'type'     => $entity->getResolveCategoryMfpType(),
                'priority' => $entity->getResolveCategoryMfpPriority() ?: 0
            ];
        }
