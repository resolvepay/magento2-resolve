...
class Payment
{
    ...
    /**
     * Resolve payment helper initialization.
     *
     ...
     * @return bool|mixed
     */
    public function isResolveAvailable()
    {
        $checkData = [
    ...
    /**
     * Get resolve method availability for product page
     *
     * @param Product|null $product
     * @return bool|mixed
     */
    public function isResolveAvailableForProduct(Product $product = null)
    {
        if (is_null($product)) {
